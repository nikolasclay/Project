...
namespace NewFlooringMasteryTest
{
    ...
    //    private const string _filePath = @"C:\SoftwareGuild\dotnet-nikolas-clay\Flooring Mastery Project\Orders_06012013.txt";
    //    private const string _originalFilePath = @"C:\SoftwareGuild\dotnet-nikolas-clay\Flooring Mastery Project\SeedOrders_06012013.txt";
