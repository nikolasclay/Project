    ...
    public class ConsoleIO
    {
        ...
        public static int GetOrderNumber()
        {
            ...
            while (!isValid)
            {
               ...
               isValid = int.TryParse(userChoice, out toReturn);
            }
        ...
        internal static string GetProduct(List<ProductDetail> list)
        {
            Console.WriteLine("The available products are below: ");
            Console.WriteLine();
            Console.WriteLine("{0,-15} {1,6:c} {2,6:c}\n", "Product Type", "CostPerSquareFoot", "LaborCostPerSquareFoot");
            Console.WriteLine("==============================================================================");
            foreach (var product in list)
            {
                Console.WriteLine("{0,-15} {1,10:c} {2,20:c}", product.ProductType, product.CostPerSquareFoot, product.LaborCostPerSquareFoot);
            }
            Console.WriteLine();
